...
export default function SanctumScreen() {
  ...
  return <Screen><AppBar title="The Sanctum" onBack={() => router.back()} /><ScreenScroll>
    ...
    <Section title="The Foundations"><Card><RowGroup><NavRow label="Database" detail={`Schema ${SCHEMA_VERSION}`} /><NavRow label="Runtime" detail={IS_EXPO_GO ? 'Expo Go' : 'Development build'} /><NavRow label="Device" detail={`${Platform.OS} ${String(Platform.Version)}`} /></RowGroup></Card></Section>
